...
module.exports = function () {
  ...
  this.getOne = async (id, result) => {
    ...
    try {
      ...
      var n = res.length;
      for (i = 0; i < n; i++) {
        var query2 = `SELECT o.bookID, o.quantity, o.totalMoney,o.orderID, b.title, b.price, b.author from ORDER_ITEM o, BOOK b WHERE o.orderID = ${res[i].orderID} and b.bookId = o.bookID`;
        pool = await conn;
