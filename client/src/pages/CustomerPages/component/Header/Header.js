  ...
  return (
    <header className={cx('wrapper')}>
      <div className={cx('inner-header') +' container'}>
                          ...
                          return (
                            <Link key={index} to={`/details?${item.id}` }>
                              <div className="d-flex align-items-start justify-content-start border-bottom py-3 px-2">
                                ...
                                <div>
                                  <p className="text-overflow-ellipsis-2 mb-3 mr-3">{item.title}</p>
        ...
        <Tippy render={(attrs) => <UserOpt option={customerOption} />} interactive placement="bottom-end" zIndex={999}>
          <Link to="/viewProfile">
